/*
Чек поинты:
[1] Доработайте пример 03.32 таким образом, чтобы сравнение дробей выполнялось посредством перегруженного оператора
        трехстороннего сравнения переписывания выражений и перегруженного оператора сравнения на равенство вместо шести
        перегруженных операторов сравнения.
[2] Реализуйте дружественные для класса Rational перегруженные операторы
        трехстороннего сравнения и сравнения на равенство.
[3] Используйте сильный порядок.
*/
